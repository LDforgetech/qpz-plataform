...
const MyTrail = () => {
  ...
  useEffect(() => {
    setCompleted(isProfileCompleted());
    const handler = () => setCompleted(isProfileCompleted());
  ...
  const handleDialogChange = (open: boolean) => {
    ...
    if (!open) setCompleted(isProfileCompleted());
  };
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="opacity-80 max-w-2xl mb-6">
                Para receber uma trilha sob medida, com cursos selecionados para
                o seu momento de carreira, é necessário responder ao diagnóstico
                de perfil. Leva poucos minutos.
              </p>
              <Button
                size="lg"
  ...
  // ====== Perfil já traçado ======
  const { profile, gaps, recommended_path } = mockProfilePayload;
  const groups = Object.keys(profile) as ProfileGroup[];
          ...
          <div className="flex items-center justify-between mb-5">
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Cursos na ordem ideal para suprir seus pontos de
                desenvolvimento.
              </p>
            </div>
